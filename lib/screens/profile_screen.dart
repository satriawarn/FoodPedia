...
import 'package:foodpedia/models/models.dart';
...
class ProfileScreen extends StatefulWidget {
  static MaterialPage page(User user) {
    return MaterialPage(
      name: FoodPediaPages.profilePath,
      key: ValueKey(FoodPediaPages.profilePath),
  ...
  Widget buildMenu() {
    return ListView(
      children: [
        buildDarkModeRow(),
        ListTile(
          title: const Text('Visit my github page'),
          onTap: () {
            Provider.of<ProfileManager>(context, listen: false)
                .tapUrl(true);
          },
